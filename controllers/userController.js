...
const sendResetPasswordEmail = async ({ email, token }, res) => {
    try {
        ...
        const mailOptions = {
            ...
            <p style="color: #2ecc71; text-align: center; font-size: 36px; margin: 20px 0;"><a href=" http://localhost:${process.env.PORT}/resetPassword?token=${token}" style="text-decoration: none; color: #2ecc71;">Reset Your Password Here</a></p>
